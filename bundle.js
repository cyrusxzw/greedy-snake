...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar Food = /** @class */ (function () {\n    function Food() {\n        this.element = document.getElementById('food');\n    }\n    Object.defineProperty(Food.prototype, \"X\", {\n        get: function () {\n            return this.element.offsetLeft;\n        },\n        enumerable: false,\n        configurable: true\n    });\n    Object.defineProperty(Food.prototype, \"Y\", {\n        get: function () {\n            return this.element.offsetTop;\n        },\n        enumerable: false,\n        configurable: true\n    });\n    Food.prototype.change = function () {\n        var positionX = Math.round((Math.random() * 41)) * 10;\n        var positionY = Math.round((Math.random() * 41)) * 10;\n        this.element.style.left = positionX + 'px';\n        this.element.style.top = positionY + 'px';\n    };\n    return Food;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Food);\n\n\n//# sourceURL=webpack://snake/./src/components/Food.ts?");

/***/ }),

/***/ "./src/components/GameControl.ts":
/*!***************************************!*\
  !*** ./src/components/GameControl.ts ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _components_Food__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/Food */ \"./src/components/Food.ts\");\n/* harmony import */ var _components_ScorePanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/ScorePanel */ \"./src/components/ScorePanel.ts\");\n/* harmony import */ var _components_Snake__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/Snake */ \"./src/components/Snake.ts\");\n\n\n\nvar GameControl = /** @class */ (function () {\n    function GameControl() {\n        var _this = this;\n        this.isLive = true;\n        this.keydownHandle = function (e) {\n            _this.direction = e.key;\n        };\n        this.snake = new _components_Snake__WEBPACK_IMPORTED_MODULE_2__.default();\n        this.food = new _components_Food__WEBPACK_IMPORTED_MODULE_0__.default();\n        this.scorePanel = new _components_ScorePanel__WEBPACK_IMPORTED_MODULE_1__.default();\n        this.direction = \"\";\n        this.init();\n    }\n    GameControl.prototype.init = function () {\n        document.addEventListener('keydown', this.keydownHandle);\n        this.run();\n    };\n    GameControl.prototype.run = function () {\n        var _this = this;\n        var X = this.snake.X;\n        var Y = this.snake.Y;\n        switch (this.direction) {\n            case 'ArrowUp':\n            case 'Up':\n                Y -= 10;\n                break;\n            case 'ArrowDown':\n            case 'Down':\n                Y += 10;\n                break;\n            case 'ArrowLeft':\n            case 'Left':\n                X -= 10;\n                break;\n            case 'ArrowRight':\n            case 'Right':\n                X += 10;\n                break;\n            default:\n                break;\n        }\n        this.checkEat(X, Y);\n        try {\n            this.snake.X = X;\n            this.snake.Y = Y;\n        }\n        catch (error) {\n            alert(error.message + 'Game Over!');\n            this.isLive = false;\n        }\n        this.isLive && setTimeout(function () {\n            _this.run();\n        }, 300 - (this.scorePanel.level - 1) * 30);\n    };\n    GameControl.prototype.checkEat = function (X, Y) {\n        if (X === this.food.X && Y === this.food.Y) {\n            this.food.change();\n            this.scorePanel.addScore();\n            this.snake.addBody();\n        }\n    };\n    return GameControl;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GameControl);\n\n\n//# sourceURL=webpack://snake/./src/components/GameControl.ts?");

/***/ }),

/***/ "./src/components/ScorePanel.ts":
/*!**************************************!*\
  !*** ./src/components/ScorePanel.ts ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar ScorePanel = /** @class */ (function () {\n    function ScorePanel(maxLevel) {\n        if (maxLevel === void 0) { maxLevel = 10; }\n        this.score = 0;\n        this.level = 1;\n        this.scoreElement = document.getElementById('score');\n        this.levelElement = document.getElementById('level');\n        this.maxLevel = maxLevel;\n    }\n    ScorePanel.prototype.addScore = function () {\n        this.scoreElement.innerHTML = (++this.score).toString();\n        if (this.score % 10 === 0) {\n            this.levelUp();\n        }\n    };\n    ScorePanel.prototype.levelUp = function () {\n        if (this.level < this.maxLevel) {\n            this.levelElement.innerHTML = (++this.level).toString();\n        }\n    };\n    return ScorePanel;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ScorePanel);\n\n\n//# sourceURL=webpack://snake/./src/components/ScorePanel.ts?");

/***/ }),

/***/ "./src/components/Snake.ts":
/*!*********************************!*\
  !*** ./src/components/Snake.ts ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar Snake = /** @class */ (function () {\n    function Snake() {\n        this.element = document.getElementById('snake');\n        this.head = document.getElementById('head');\n        this.body = this.element.getElementsByTagName('div');\n    }\n    Object.defineProperty(Snake.prototype, \"X\", {\n        get: function () {\n            return this.head.offsetLeft;\n        },\n        set: function (value) {\n            if (this.X === value) {\n                return;\n            }\n            if (value < 0 || value > 400) {\n                throw new Error('蛇撞墙了！');\n            }\n            if (this.body[1] && this.body[1].offsetLeft === value) {\n                if (value > this.X) {\n                    value = this.X - 10;\n                }\n                else {\n                    value = this.X + 10;\n                }\n            }\n            this.moveBody();\n            this.head.style.left = value + 'px';\n            this.checkCross();\n        },\n        enumerable: false,\n        configurable: true\n    });\n    Object.defineProperty(Snake.prototype, \"Y\", {\n        get: function () {\n            return this.head.offsetTop;\n        },\n        set: function (value) {\n            if (this.Y === value) {\n                return;\n            }\n            if (value < 0 || value > 410) {\n                throw new Error('蛇撞墙了！');\n            }\n            if (this.body[1] && this.body[1].offsetTop === value) {\n                if (value > this.Y) {\n                    value = this.Y - 10;\n                }\n                else {\n                    value = this.Y + 10;\n                }\n            }\n            this.moveBody();\n            this.head.style.top = value + 'px';\n            this.checkCross();\n        },\n        enumerable: false,\n        configurable: true\n    });\n    Snake.prototype.addBody = function () {\n        this.element.insertAdjacentHTML('beforeend', '<div></div>');\n    };\n    Snake.prototype.moveBody = function () {\n        for (var i = this.body.length - 1; i > 0; i--) {\n            var prevBodyX = this.body[i - 1].offsetLeft;\n            var prevBodyY = this.body[i - 1].offsetTop;\n            this.body[i].style.left = prevBodyX + 'px';\n            this.body[i].style.top = prevBodyY + 'px';\n        }\n    };\n    Snake.prototype.checkCross = function () {\n        for (var i = 1; i <= this.body.length; i++) {\n            if (this.body[i] && this.body[i].offsetLeft === this.X && this.body[i].offsetTop === this.Y) {\n                throw new Error('撞到自己了！');\n            }\n        }\n    };\n    return Snake;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Snake);\n\n\n//# sourceURL=webpack://snake/./src/components/Snake.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_index_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style/index.less */ \"./src/style/index.less\");\n/* harmony import */ var _components_GameControl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/GameControl */ \"./src/components/GameControl.ts\");\n\n\nnew _components_GameControl__WEBPACK_IMPORTED_MODULE_1__.default();\n\n\n//# sourceURL=webpack://snake/./src/index.ts?");
